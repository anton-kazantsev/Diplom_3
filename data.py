class DataUrl:
    ...
    RECOVERY_INPUT_EMAIL_PAGE = 'https://stellarburgers.nomoreparties.site/forgot-password'
    RECOVERY_INPUT_PASSWORD_PAGE = 'https://stellarburgers.nomoreparties.site/reset-password'
    FEED_PAGE = 'https://stellarburgers.nomoreparties.site/feed'
    INGREDIENT_PAGE = 'https://stellarburgers.nomoreparties.site/ingredient/61c0c5a71d1f82001bdaaa6e'


class DataUser:

    EMAIL = 'antonkazantcev@yandex.ru'
    PASSWORD = '1234578'